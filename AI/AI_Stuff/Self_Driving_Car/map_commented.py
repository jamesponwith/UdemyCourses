...
class Car(Widget):
    ...
    # The signals are the density of sand around the respective sensor
    # Take a 200 X 200 square around each sensor, for each square divide the 
    # number of 1s in the square by the total number of cells in the square 
    # 20 * 20 = 400 because 1 represents sand
